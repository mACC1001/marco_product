...
export const projects: Project[] = [
  {
    ...
    caseStudy: {
      overview: 'As the product manager for a behavioral health organization serving K-12 school districts, I designed and led the development of an analytics dashboard that gave program administrators real-time visibility into enrollment pipelines, service utilization, provider visit tracking, and insurance claims across multiple school sites.',
      ...
      approach: [
        ...
        'Partnered with the data engineering team to design ETL pipelines pulling from the EHR, billing system, and enrollment database into a unified data warehouse.',
      ...
      results: [
        ...
        'Identified $120K+ in previously missed billing opportunities within the first quarter of launch.',
        'Enabled administrators to proactively reallocate provider capacity, improving utilization rates by 18%.',
        'Dashboard adoption reached 95% of target users within 6 weeks of launch.',
        'District partners cited the dashboard as a key factor in renewing and expanding program contracts.',
      ],
      learnings: [
        ...
        'Role-based data access was critical in a multi-tenant school environment — privacy requirements shaped the architecture early.',
        'Iterating on prototypes with real administrators caught usability issues that would have been costly to fix post-launch.',
        'The ETL pipeline design required close collaboration between product and data engineering to balance freshness with system load.',
      ],
    },
  },
  {
